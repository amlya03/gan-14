...
$(document).ready(function() {
			...
			$(document).delegate('.edit', 'click', function() {
				...
				buttons.html("<a id='save' class='btn btn-success'><i class='fas fa-save fa-fw'></i>Save</a>&nbsp;&nbsp;&nbsp;<a class='btn btn-danger delete' id='" + id.html() + "'><i class='fas fa-trash fa-fw'></i>Delete</a>");
			});
