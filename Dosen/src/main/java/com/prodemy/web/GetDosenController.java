...
import com.prodemy.bean.Dosen;
import com.prodemy.dao.DosenDao;
...
public class GetDosenController extends HttpServlet {
	...
	private void showNewForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("dosen-insertform.jsp");
		rd.forward(request, response);
	}	
	...
	private void showEditForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("dosen-updateform.jsp");
